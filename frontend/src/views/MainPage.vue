...
<style lang="less">
@import url("../assets/fonts/NotoSans.css");
...
.home {
  ...
  .in-container {
    ...
    .diagram {
      ...
      margin-top: 60px;
      background: url(@/assets/images/img_banner_diagram.png) no-repeat 50% 50%;
